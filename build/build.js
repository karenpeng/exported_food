...
var BigBrother = _react2['default'].createClass({
  ...
  PropTypes: {
    ...
    totals: _react2['default'].PropTypes.array.isRequired
  },
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          null,
          'Category:',
          _react2['default'].createElement(_catJsx.Cat, { options: this.props.cats, handleCat: this.handleCat })
        ),
        _react2['default'].createElement(
          'span',
          null,
          'Sorted By:',
          _react2['default'].createElement(_sortJsx.Sort, { handleSort: this.handleSort })
        )
      ),
      _react2['default'].createElement('div', { id: 'main' }),
      _react2['default'].createElement('section', { id: 'bottom' }),
      _react2['default'].createElement(
        'section',
        { id: 'above', style: timeMachine },
...
var Year = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    return _react2['default'].createElement('input', { id: 'yearBar', style: _w, type: 'range', value: this.state.year, min: '1999', max: '2014', step: '1', onChange: this.handleSlide });
  }
});
exports.Year = Year;
...
var jqxhr = $.getJSON("./data/json/data.json", function () {}).done(function (data) {
  ...
  _react2['default'].render(_react2['default'].createElement(_controlBigBrotherJsx.BigBrother, { data: data, cats: cats, totals: (0, _dataModelGetAllJs.getAll)(data) }), document.getElementById('bigBrother'));
}).fail(function (err) {
  console.dir(err);
});
