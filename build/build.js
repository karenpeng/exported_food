...
var BigBrother = _react2['default'].createClass({
  ...
  componentDidMount: function componentDidMount() {
    //initBar()
    (0, _viewBarJs.updateBar)(this.props.data[this.state.cat], this.state.index);
  },
  ...
  handleCategory: function handleCategory(val) {
    this.setState({
      cat: val
    });
  },
...
},{"../view/bar.js":163,"./cat.jsx":159,"./sort.jsx":160,"./year.jsx":161,"react":157}],159:[function(require,module,exports){
'use strict';
...
var Year = _react2['default'].createClass({
  ...
  render: function render() {
    var _w = { width: window.innerWidth - 100 + 'px' };
...
_d32['default'].json('./data/bySubCat.json', function (error, json) {
